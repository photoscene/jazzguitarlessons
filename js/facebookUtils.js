(function(exports, global) {
    ...
    "use strict";
    angular.module("facebookUtils").service("facebookUser", ["$timeout", "$window", "$rootScope", "$q", "facebookConfigDefaults", "facebookConfigSettings", "facebookSDK", function($timeout, $window, $rootScope, $q, facebookConfigDefaults, facebookConfigSettings, facebookSDK) {
    ...
    "use strict";
    angular.module("facebookUtils").directive("facebookLoginButton", ["$timeout", "facebookUser", function($timeout, facebookUser) {
        return {
